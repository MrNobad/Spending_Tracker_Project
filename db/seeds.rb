...
transaction1 = Transaction.new({"merchant_id" => merchant1.id, "tag_id" => tag1.id, "amount" => 37.50 })
transaction2 = Transaction.new({"merchant_id" => merchant2.id, "tag_id" => tag5.id, "amount" => 57.00 })
transaction3 = Transaction.new({"merchant_id" => merchant3.id, "tag_id" => tag3.id, "amount" => 112.35 })
transaction4 = Transaction.new({"merchant_id" => merchant4.id, "tag_id" => tag2.id, "amount" => 19.95})
transaction5 = Transaction.new({"merchant_id" => merchant5.id, "tag_id" => tag4.id, "amount" => 25.00})
transaction6 = Transaction.new({"merchant_id" => merchant1.id, "tag_id" => tag2.id, "amount" => 23.60})
